...
// NOTE Seems like this is what we're working with
...
static int tuxctl_ldisc_open(struct tty_struct *tty) { // NOTE Prob use
...
static void tuxctl_ldisc_close(struct tty_struct *tty) { // NOTE Prob use
    tuxctl_ldisc_data_t *data;
    unsigned long flags;
